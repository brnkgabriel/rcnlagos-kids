<template>
  <div class="h-full w-screen flex flex-col landscape:flex-row justify-center items-center font-body relative">
    <NuxtLink href="/" :class="logo">
      <img src="/icons/logo-colored.svg" alt="logo"/>
    </NuxtLink>
    <div aria-label="slides" class="relative w-full h-40% overflow-hidden landscape:h-full landscape:w-40%">
