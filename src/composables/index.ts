...
export const useUi = () => {
  return {
    ...
    studentsComponent: "h-full flex flex-col md:flex-row md:gap-x-2 landscape:flex-row landscape:gap-x-2 portrait:flex-col portrait:justify-between",
    cardTimeline: "",
    selectedComponent: "selected h-[60%] landscape: h-full md:h-full flex flex-col",
    ...
    studentsCardWrap: "flex flex-wrap gap-2 overflow-y-auto overflow-x-hidden pb-4"
  }
}
